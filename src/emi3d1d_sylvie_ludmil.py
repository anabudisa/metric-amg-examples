...
if __name__ == '__main__':
    ...
    result_dir = f'./results/emi3d1d_sylvie_ludmil/'
    ...
    # Meshes
    mesh3d = Mesh()
    with XDMFFile(mesh3d.mpi_comm(), './data/sylvie_ludmil/3d_c.xdmf') as f:
        f.read(mesh3d)

    mesh1d = Mesh()
    with XDMFFile(mesh3d.mpi_comm(), './data/sylvie_ludmil/1d_graph.xdmf') as f:
        f.read(mesh1d)
